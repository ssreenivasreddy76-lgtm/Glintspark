...
export default function Careers() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 relative overflow-hidden">
      ...
      {/* Culture Values */}
      <section className="py-16 bg-white border-y border-slate-200 relative z-10">
            ...
            >
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-[10px] font-black uppercase bg-slate-100 text-slate-600 px-2 py-0.5 rounded-md border border-slate-200">{job.dept}</span>
